# -*- coding: utf-8 -*-
"""
Created on Thu May 24 09:48:28 2018
...
def get_datasets_20newsgroup(subset='train', categories=None, shuffle=True, random_state=42, remove=None):
    """
    ...
    """
    datasets = fetch_20newsgroups(subset=subset, categories=categories, shuffle=shuffle, random_state=random_state, data_home="./data/datasets/20newsgroup_cache", remove=remove)
    return datasets
...
def load_data_labels_remove_SW(datasets):
    """
...
def load_data_labels_amazon(datasets):
    """
    Load data and labels
    :param datasets:
    :return:
...
# datasets = get_datasets_20newsgroup(subset='train', categories=['alt.atheism'], remove=('headers', 'footers', 'quotes'))
# x_text, _ = load_data_labels(datasets)

# filtered_words = [word for word in x_text[0].split(" ") if word not in stopwords.words('english')]
# print x_text[0].split(" ")
# for word in x_text[0]:
    # print word
